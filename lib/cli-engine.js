...
function processText(text, configHelper, filename, fix, allowInlineConfig, linter) {
    ...
    if (processor) {
        ...
        if (processor.prepare) {
            processor.prepare(configHelper.specificConfig, configHelper);
        }
        
        const parsedBlocks = processor.preprocess(text, filename, configHelper.specificConfig);
        ...
        messages = processor.postprocess(unprocessedMessages, filename, configHelper.specificConfig);
